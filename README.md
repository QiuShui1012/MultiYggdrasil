...
authHost = "https://a.random.mirror"     # (1.20.2-) “OFFICIAL”类型的特定值，URL结尾*不应有*/，但是有也可以
accountsHost = "https://a.random.mirror" # (1.20.3-) “OFFICIAL”类型的特定值，URL结尾*不应有*/，但是有也可以
...
## 版本支持情况
1.19.1-：接受支持请求，若无请求则不做测试/修bug/移植
1.19.1+：LTS长期支持